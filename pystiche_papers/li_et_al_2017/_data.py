...
def images() -> DownloadableImageCollection:
    root = "https://raw.githubusercontent.com/Yijunmaverick/UniversalStyleTransfer/master/input/"
    ...
    content_images = {
        ...
        "flower": DownloadableImage(
            urljoin(content_root, "006.jpg"), md5="9b3ac3a8bae76cc9cce3af86dd2df3b9",
        ),
        "vincent": DownloadableImage(
            urljoin(content_root, "023.jpg"), md5="ff217acb6db32785b8651a0e316aeab3",
        ),
        "women2": DownloadableImage(
            urljoin(content_root, "028.jpg"), md5="981b6ecfb0bed1f6348989604203eb9e",
        ),
        "women3": DownloadableImage(
            urljoin(content_root, "04.jpg"), md5="a484e56dd4f252c4d675c465526f3996",
        ),
        "bridge": DownloadableImage(
            urljoin(content_root, "05.jpg"), md5="be29eaba58e6c5c691110ac52d553d05",
        ),
